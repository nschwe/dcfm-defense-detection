...
Writes:
  results/k_sweep_universal4/optimal_k_publication.png
  results/k_sweep_universal4/optimal_k_publication.pdf
...
def main():
    ...
    if args.optimal_k in Ks:
        ...
        ax.annotate(
            ...
            xy=(opt_idx, min(sm_acc[opt_idx], ms_acc[opt_idx])),
            xytext=(opt_idx + 0.35, 0.790),
    ...
    png_path = out_dir / "optimal_k_publication.png"
    pdf_path = out_dir / "optimal_k_publication.pdf"
